...
partial class ConfigurationServiceWorker
{
    ...
    {
        pLogger.Log(Microsoft.Extensions.Logging.LogLevel.Debug, "ConfigurationServiceWorker.ComputePiWorker() was started.");
        ...
        pLogger.Log(Microsoft.Extensions.Logging.LogLevel.Debug, "ConfigurationServiceWorker.ComputePiWorker() released for work");
        ...
        while (true)
        {
            ...
            {
                pLogger.Log(LogLevel.Error, "Exception in ConfigurationServiceWorker.ComputePiWorker of '" + ex.ToString() + "'");
            }
        }
    }
