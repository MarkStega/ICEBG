/*
** The source file "Materia.Blazor.custom.events.ts" is processed by webpack to become
** 'Materia.Blazor.lib.module.NEEDS.EDIT.AND.COPY.js'.
**
** After being created the module code must be removed and 'export' must be added to the
** two function calls. The file is then copied to 'Materia.Blazor.lib.module.js'.
**
** 'Materia.Blazor.lib.module.js' is checked into the repository in order to insure
** inclusion as a static asset of M.B and to prevent the publish step of M.B.W.S from failure
