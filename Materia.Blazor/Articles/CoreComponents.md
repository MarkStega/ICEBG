...
Material Web implements web components which implement the components defined in Material Design 3. We term these "Core Components". Materia.Blazor also has non core ["Plus Components"](xref:A.PlusComponents).
