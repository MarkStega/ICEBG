...
Material Theme closely specifies component HTML markup. Materia.Blazor implements many of these as [Core Components](xref:A.CoreComponents). Materia.Blazor also 
