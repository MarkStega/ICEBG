...
- Register services by calling [services.AddMBServices()](xref:Materia.Blazor.ServiceCollectionExtensions#methods)).
...
[![Docs](https://img.shields.io/static/v1?label=API%20Documentation&message=MBAnchor&color=brightgreen)](xref:Materia.Blazor.MBAnchor)