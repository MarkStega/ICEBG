...
public sealed class MBIconButton : ComponentFoundation
{
        ...
        string slot)
    {
        ...
        {
            MBIconButtonStyle.Filled => "mx-filled-icon-button",
            MBIconButtonStyle.FilledTonal => "mx-filled-tonal-icon-button",
            MBIconButtonStyle.Icon => "mx-icon-button",
            MBIconButtonStyle.Outlined => "mx-outlined-icon-button",
        ...
        builder.OpenElement(rendSeq, componentName);
        {
            ...
            if ((componentName.StartsWith("mx-icon-button")) && (!string.IsNullOrEmpty(iconLink)))
            {
