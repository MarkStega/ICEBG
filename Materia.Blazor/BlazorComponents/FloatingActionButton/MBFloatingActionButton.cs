...
public sealed class MBFloatingActionButton : ComponentFoundation
{
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
        ...
        {
            MBFloatingActionButtonStyle.Branded => "mx-branded-fab",
            MBFloatingActionButtonStyle.Primary => "mx-fab",
            MBFloatingActionButtonStyle.Secondary => "mx-fab",
            MBFloatingActionButtonStyle.Surface => "mx-fab",
            MBFloatingActionButtonStyle.Tertiary => "mx-fab",
