    ...
    where TListElement : MBSingleSelectElement<T>
{
    ...
    /// </summary>
    [Parameter] public Materia.Blazor.MBItemValidation? ItemValidation { get; set; }
    ...
    protected override async Task OnParametersSetAsync()
    {
        ...
        if ((Items == null && _cachedItems != null) || (Items != null && _cachedItems == null) || (Items != null && _cachedItems != null && !Items.SequenceEqual(_cachedItems)))
        {
            ...
            var validatedValue = ValidateItemList(Items, Materia.Blazor.MBItemValidation.DefaultToFirst);
