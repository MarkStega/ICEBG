...
internal class LoggingService : IMBLoggingService
{
    ...
    /// <summary>
    /// Logs a Critical message identifying it as having come from Materia.Blazor
    /// </summary>
    ...
    public void LogCritical(string message)
    {
        ...
        {
            Logger.LogCritical("Materia.Blazor Critical: " + message);
        }
    }

    /// <summary>
    /// Logs an Error message identifying it as having come from Materia.Blazor
    /// </summary>
    /// <param name="message">Log message</param>
    public void LogError(string message)
    {
        ...
        {
            Logger.LogError("Materia.Blazor Error: " + message);
        }
    }

    /// <summary>
    /// Logs a Warning message identifying it as having come from Materia.Blazor
    /// </summary>
    /// <param name="message">Log message</param>
    public void LogWarning(string message)
    {
        ...
        {
            Logger.LogWarning("Materia.Blazor Warning: " + message);
        }
    }

    /// <summary>
    /// Logs an Information message identifying it as having come from Materia.Blazor
    /// </summary>
    /// <param name="message">Log message</param>
    public void LogInformation(string message)
    {
        ...
        {
            Logger.LogInformation("Materia.Blazor Information: " + message);
        }
    }

    /// <summary>
    /// Logs a Debug message identifying it as having come from Materia.Blazor
    /// </summary>
    /// <param name="message">Log message</param>
    public void LogDebug(string message)
    {
        ...
        {
            Logger.LogDebug("Materia.Blazor Debug: " + message);
        }
    }

    /// <summary>
    /// Logs a Trace message identifying it as having come from Materia.Blazor
    /// </summary>
    /// <param name="message">Log message</param>
    public void LogTrace(string message)
    {
        ...
        {
            Logger.LogTrace("Materia.Blazor Trace: " + message);
        }
    }
