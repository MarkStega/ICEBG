...
- Accepts an optional [MBToastServiceConfiguration](xref:Materia.Blazor.MBToastServiceConfiguration).
...
[![Docs](https://img.shields.io/static/v1?label=API%20Documentation&message=IMBToastService&color=brightgreen)](xref:Materia.Blazor.IMBToastService)
