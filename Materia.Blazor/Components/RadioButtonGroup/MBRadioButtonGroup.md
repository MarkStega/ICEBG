...
- You can provide a function delegate to the `GetKeysFunc` parameter - we have used two variants of this:
  ...
  - You can see an example of this in the [MBList demonstration website page's code](https://github.com/Material-Blazor/Materia.Blazor/blob/main/Materia.Blazor.Website/Pages/List.razor#L155).
...
[![Docs](https://img.shields.io/static/v1?label=API%20Documentation&message=MBRadioButtonGroup&color=brightgreen)](xref:Materia.Blazor.MBRadioButtonGroup`1)
